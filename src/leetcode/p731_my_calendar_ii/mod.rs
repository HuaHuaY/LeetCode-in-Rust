...
mod tests {
    ...
    #[test]
    fn test1() {
        let mut my_calendar = MyCalendarTwo::new();
        assert!(my_calendar.book(10, 20));
        assert!(my_calendar.book(50, 60));
        assert!(my_calendar.book(10, 40));
        assert!(!my_calendar.book(5, 15));
        assert!(my_calendar.book(5, 10));
        assert!(my_calendar.book(25, 55));
    }
}
